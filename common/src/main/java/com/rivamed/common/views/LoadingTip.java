...
/**
 * @author : Amos_bo
 * @package: ccom.rivamed.common.views
...
public class LoadingTip extends LinearLayout {
    ...
    private void initView(Context context) {
        View.inflate(context, R.layout.layout_empty_error, this);
    ...
    public void setLoadingTip(LoadStatus loadStatus) {
        switch (loadStatus) {
            case empty:
                ...
                img_tip_logo.setImageResource(R.drawable.img7);
                break;
            case sereverError:
                setVisibility(View.VISIBLE);
                img_tip_logo.setVisibility(View.VISIBLE);

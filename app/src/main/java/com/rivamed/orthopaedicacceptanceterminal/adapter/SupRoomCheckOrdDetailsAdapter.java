 ...
 * @Version: 1.0
 */
public class SupRoomCheckOrdDetailsAdapter extends SimpleRecyclerAdapter<MianFuncationParam,
        SupRoomCheckOrdDetailsAdapter.MyHolder> {
    public SupRoomCheckOrdDetailsAdapter(Context context) {

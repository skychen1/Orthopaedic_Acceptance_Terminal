 ...
 * @Version: 1.0
 */
public class CstCostSubmitAdapter extends SimpleRecyclerAdapter<MianFuncationParam,
        CstCostSubmitAdapter.MyHolder> {
    public CstCostSubmitAdapter(Context context) {
